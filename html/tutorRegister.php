...
<body>
    ...
    <div id="container" class="dashboard">
        ...
        <form name = "frmRegister" action="phpFunctions/saveTutor.php" onsubmit="return validation();" method="POST">
            ...
            <input type="text" class = "seventyPercent" id="address" name="address" required placeholder="First Line of Address">
            <input type="text" class="twentyPercent" id="postCode" name="postcode" placeholder="Post Code">

            <input type="text" class="halfSize" name="registerDate" id="registerDate" placeholder="Date Registered">
            <input type="text" class="halfSize" id="dob" name="dob" placeholder="Date of Birth (dd/mm/yyyy)">

            <input class = "seventyPercent id="email type="text" name="email" placeholder="E-mail">
            <input type="text" class = "twentyPercent" id="age" name="age" placeholder="Age">
            <input class = "fullSize" id="password" type="password" name="tutorPassword" placeholder="Password">
            ...
            <br>
            <input class="halfSize" type="text" name="officeNum" required placeholder="Office Number">
            <input class="halfSize" type="text" name="extNum" required placeholder="Extension Number">

            <input type="text" class = "fullSize" id="NIN" name = "fees" placeholder="National Insurance Number">
            ...
            <input type="text" class = "seventyPercent" id="nokAddress" name="address" required placeholder="First Line of Address">
            <input type="text" class="twentyPercent" id="nokPostcode" name="postcode" placeholder="Post Code">
            <input type="text" class="fullSize" name="nokContact" id="nokContact" placeholder="Next of Kin Contact Number">
